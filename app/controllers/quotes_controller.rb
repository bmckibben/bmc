class QuotesController < ApplicationController
  ...
  def create
    ...
    if @quote.save
      respond_to do |format|
        format.html { redirect_to quotes_path, notice: "Product was successfully created." }
  ...
  def update
    if @quote.update(quote_params)
      respond_to do |format|
        format.html { redirect_to quotes_path, notice: "Product was successfully updated." }
  ...
  def destroy
    @quote.destroy
    respond_to do |format|
      format.html { redirect_to quotes_path, notice: "Product was successfully destroyed." }
